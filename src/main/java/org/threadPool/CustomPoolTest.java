...
public class CustomPoolTest {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        System.out.println("=== CustomThreadPoolExecutor Test ===");

        runBenchmark(executor);
    }

    private static void runBenchmark(CustomExecutor executor) throws InterruptedException {
